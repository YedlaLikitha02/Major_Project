...
export default function PoliceDashboard(){
  ...
  const loadAlerts = () => {
    // ✅ Now using police-alerts API (only shows sos_single + sos_double + legacy)
    axios.get("https://major-project-9.onrender.com/api/police-alerts/")
      .then(res => {
  ...
  // ✅ Helper: badge color by SOS type
  const sosBadge = (type) => {
    const styles = {
  ...
  return(
    <div style={page}>
      ...
      <div style={statsContainer}>
        ...
        {/* ✅ NEW: Double SOS count for police */}
...
const exportBtn={padding:"10px 18px",background:"#2563eb",border:"none",color:"white",borderRadius:8,cursor:"pointer"};
...
const criticalBlinkRow={animation:"blinkCritical 0.5s infinite",background:"#7f1d1d"};
